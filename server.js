...
app.post('/register', (req, res) => {
  let registerConnection = mongoose.createConnection("mongodb+srv://RaviKumar:Ravi%40123@cluster0.objb5kv.mongodb.net/UserData")
...
app.post('/login', (req, res) => {
  let loginConnection = mongoose.createConnection("mongodb+srv://RaviKumar:Ravi%40123@cluster0.objb5kv.mongodb.net/UserData")
...
app.get('/index', (req, res) => {
  if (isauthenticate == 1) {
    let userConnection = mongoose.createConnection("mongodb+srv://RaviKumar:Ravi%40123@cluster0.objb5kv.mongodb.net/" + ((email).split("@"))[0])
...
app.post('/forget', (req, res) => {
  let forgetConnection = mongoose.createConnection("mongodb+srv://RaviKumar:Ravi%40123@cluster0.objb5kv.mongodb.net/UserData")
...
app.post('/reset', (req, res) => {
  let resetConnection = mongoose.createConnection("mongodb+srv://RaviKumar:Ravi%40123@cluster0.objb5kv.mongodb.net/UserData")
...
app.post('/send', (req, res) => {
  let checkConnection = mongoose.createConnection("mongodb+srv://RaviKumar:Ravi%40123@cluster0.objb5kv.mongodb.net/UserData")
  ...
  checkModel.find({ Email: req.body.givenEmail }, (err, found) => {
    if (Object.keys(found).length == 0) {
      ...
      let friendConnection = mongoose.createConnection("mongodb+srv://RaviKumar:Ravi%40123@cluster0.objb5kv.mongodb.net/" + ((email).split("@"))[0])
      ...
      message.save()
      let sendMessageConnection = mongoose.createConnection("mongodb+srv://RaviKumar:Ravi%40123@cluster0.objb5kv.mongodb.net/" + ((req.body.givenEmail).split("@"))[0])
...
app.post('/message', (req, res) => {
  let messageConnection = mongoose.createConnection("mongodb+srv://RaviKumar:Ravi%40123@cluster0.objb5kv.mongodb.net/" + ((email).split("@"))[0])
